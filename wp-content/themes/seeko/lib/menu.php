 ...
 */
if ( ! class_exists( 'SVQ_Walker_Nav_Walker' ) ) {
	 ...
	 */
	class SVQ_Walker_Nav_Walker extends Walker_Nav_Menu {
		...
		public static function fallback( $args ) {
			if ( current_user_can( 'edit_theme_options' ) ) {
				...
				$fallback_output .= '>';
				$fallback_output .= '<li><a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" title="' . esc_attr__( 'Add a menu', 'seeko' ) . '">' . esc_html__( 'Add a menu', 'seeko' ) . '</a></li>';
				$fallback_output .= '</ul>';
				if ( $container ) {
					$fallback_output .= '</' . esc_attr( $container ) . '>';
				}
...
function svq_get_menu_icon( $icon, $depth, $args, $default = false ) {

	$title_icon = '';
	if ( $default === false ) {
		$default_icon = SVQ_FW::get_config( 'menu_icon_default' );
		$default      = svq_option( 'menu_icon', $default_icon );
	}
