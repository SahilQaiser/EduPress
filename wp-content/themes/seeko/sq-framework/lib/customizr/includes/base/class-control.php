 ...
 * @package Seeko\Customizer
 */
class Seeko_Customizer_Base_Control extends WP_Customize_Control {
	...
	protected function render() {
		...
		$class = sprintf( 'seeko-col-%1$s customize-control customize-control-%2$s', $this->column, $this->type );
	...
	protected function content_template() {
		...
		<# if ( data.responsive ) { #>
			...
			#>
			<div class="seeko-responsive-control">
		<# } #>
		<# if ( data.label ) { #>
		...
		<# _.each( viewport, function ( device ) { #>
			<# if ( data.responsive ) { #>
				...
				#>
				<div class="seeko-viewport seeko-viewport-{{ device }}">
			<# } #>
		...
		<# } ) #>
		<# if ( data.responsive ) { #>
			<div class="seeko-responsive-switcher">
				<div class="seeko-responsive-switcher-buttons">
					<# _.each( viewport, function ( device ) { #>
						<a class="seeko-responsive-switcher-button seeko-responsive-switcher-{{ device }}" data-device="{{ device }}">
							<span class="seeko-responsive-switcher-icon">
								<img src="<?php echo esc_url( Seeko_Customizer_Utils::get_assets_url() ); ?>/img/device-{{ device }}.svg">
							</span>
						</a>
					<# } ) #>
				</div>
