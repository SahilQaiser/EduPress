 ...
 * @package Seeko\Customizer
 */
class Seeko_Customizer_Kirki_Extend_Output_Border extends Seeko_Customizer_Kirki_Extend_Base_Output {
			...
			switch ( $output['choice'] ) {
				...
				case 'width':
					if ( isset( $value[ $output['choice'] ] ) && ! empty( $value[ $output['choice'] ] ) ) {
						$input_value = Seeko_Customizer_Control_Input::format_value( $value[ $output['choice'] ] );
