 ...
 * @package Seeko\Customizer
 */
class Seeko_Customizer_Kirki_Extend_Output_Box_Model extends Seeko_Customizer_Kirki_Extend_Base_Output {
	...
	protected function apply_output( $output, $value ) {
		...
		$default_unit = Seeko_Customizer_Control_Box_Model::$default_unit;
