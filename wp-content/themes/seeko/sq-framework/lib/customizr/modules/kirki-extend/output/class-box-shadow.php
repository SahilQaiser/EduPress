 ...
 * @package Seeko\Customizer
 */
class Seeko_Customizer_Kirki_Extend_Output_Box_Shadow extends Seeko_Customizer_Kirki_Extend_Base_Output {
	...
	protected function apply_output( $output, $value ) {
		...
		$value = Seeko_Customizer_Group_Control_Box_Shadow::format_value( $value, $output['units'] );
