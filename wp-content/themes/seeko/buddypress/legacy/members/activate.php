...
<div id="buddypress">
	...
	<div class="page" id="activate-page">
		...
		<?php else : ?>
			...
			<form action="" method="post" class="standard-form row" id="activation-form">
				<div class="col-md-8">
					<label for="key"><?php _e( 'Activation Key:', 'buddypress' ); ?></label>
					<div class="input-group">
						<input class="form-control" type="text" name="key" id="key" value="<?php echo esc_attr( bp_get_current_activation_key() ); ?>" />
						<div class="submit input-group-append">
							<input class="btn btn-outline-primary" type="submit" name="submit" value="<?php esc_attr_e( 'Activate', 'buddypress' ); ?>" />
						</div>
					</div>
				</div>
