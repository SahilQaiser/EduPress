	...
	<ul id="friend-list" class="item-list">
		<?php while ( bp_members() ) : bp_the_member(); ?>
			...
			<li id="friendship-<?php bp_friend_friendship_id(); ?>">
				...
				<div class="action">
					<a class="friendship-button btn btn-sm btn-primary accept" href="<?php bp_friend_accept_request_link(); ?>"><?php _e( 'Accept', 'buddypress' ); ?></a> &nbsp;
					<a class="friendship-button btn btn-sm reject" href="<?php bp_friend_reject_request_link(); ?>"><?php _e( 'Reject', 'buddypress' ); ?></a>
