...
<form action="" method="post" id="notifications-bulk-management">
		...
		<thead>
			<tr>
				<th class="bulk-select-all">
					...
					<label for="select-all-notifications"><?php
		...
		<tbody>
			...
			<?php while ( bp_the_notifications() ) : bp_the_notification(); ?>
				...
				<tr>
					...
					<td class="notification-actions"><?php bp_the_notification_action_links( 'sep= ' ); ?></td>
				</tr>
	...
	<div class="notifications-options-nav">
		<?php svq_bp_notifications_bulk_management_dropdown(); ?>
