...
<form action="<?php echo bp_displayed_user_domain() . bp_get_settings_slug() . '/delete-account'; ?>" name="account-delete-form" id="account-delete-form" class="standard-form" method="post">
	...
	<div class="form-group form-check">
		...
		<label for="delete-account-understand"><?php _e( 'I understand the consequences.', 'buddypress' ); ?></label>
	</div>

	<div class="submit">
		<input type="submit" disabled="disabled" value="<?php esc_attr_e( 'Delete Account', 'buddypress' ); ?>" id="delete-account-button" class="btn btn-primary" name="delete-account-button" />
	</div>
