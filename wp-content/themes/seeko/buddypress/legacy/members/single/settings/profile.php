...
<form action="<?php echo trailingslashit( bp_displayed_user_domain() . bp_get_settings_slug() . '/profile' ); ?>" method="post" class="standard-form" id="settings-form">
					...
					<tbody>
						...
						<?php while ( bp_profile_fields() ) : bp_the_profile_field(); ?>
							...
							<tr <?php bp_field_css_class(); ?>>
								...
								<td class="field-visibility"><?php bp_profile_settings_visibility_select(['class' => 'bp-xprofile-visibility form-control-sm']); ?></td>
							</tr>
	...
	<div class="submit">
		<input id="submit" type="submit" name="xprofile-settings-submit" value="<?php esc_attr_e( 'Save Settings', 'buddypress' ); ?>" class="auto btn btn-primary" />
	</div>
