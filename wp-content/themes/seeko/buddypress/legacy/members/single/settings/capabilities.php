...
<form action="<?php echo bp_displayed_user_domain() . bp_get_settings_slug() . '/capabilities/'; ?>" name="account-capabilities-form" id="account-capabilities-form" class="standard-form" method="post">
	...
	<div class="form-group form-check">
		...
		<label for="user-spammer"> <?php esc_html_e( 'This user is a spammer.', 'buddypress' ); ?></label>
	</div>

	<div class="submit">
		<input type="submit" value="<?php esc_attr_e( 'Save', 'buddypress' ); ?>" id="capabilities-submit" class="btn btn-primary" name="capabilities-submit" />
	</div>
