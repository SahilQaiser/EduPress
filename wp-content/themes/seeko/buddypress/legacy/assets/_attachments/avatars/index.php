...
<script id="tmpl-bp-avatar-delete" type="text/html">
	<# if ( 'user' === data.object ) { #>
		...
		<p><a class="btn btn-xs btn-secondary edit" id="bp-delete-avatar" href="#"><?php esc_html_e( 'Delete My Profile Photo', 'buddypress' ); ?></a></p>
	<# } else if ( 'group' === data.object ) { #>
		...
		<p><a class="btn btn-xs btn-secondary edit" id="bp-delete-avatar" href="#"><?php esc_html_e( 'Delete Group Profile Photo', 'buddypress' ); ?></a></p>
	<# } else { #>
