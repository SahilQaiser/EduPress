		...
		<div class="item-body" id="group-create-body">
					...
					<fieldset class="group-create-types">
						...
						<?php foreach ( $group_types as $type ) : ?>
							<div class="checkbox">
								...
								<input type="checkbox" name="group-types[]" id="<?php printf( 'group-type-%s', $type->name ); ?>" value="<?php echo esc_attr( $type->name ); ?>" <?php checked( true, ! empty( $type->create_screen_checked ) ); ?> />
				...
				<fieldset class="group-create-invitations">
					...
					<div class="radio">
						...
						<div class="form-check">
							...
							<label for="group-invite-status-members"><?php _e( 'All group members', 'buddypress' ); ?></label>
						</div>
						<div class="form-check">
							...
							<label for="group-invite-status-mods"><?php _e( 'Group admins and mods only', 'buddypress' ); ?></label>
						</div>
						<div class="form-check">
							...
							<label for="group-invite-status-admins"><?php _e( 'Group admins only', 'buddypress' ); ?></label>
			...
			<?php if ( bp_is_group_creation_step( 'group-avatar' ) ) : ?>
				...
				<?php if ( 'upload-image' == bp_get_avatar_admin_step() ) : ?>
					...
					<div class="row">
						<div class="left-menu col-md-3">
							<figure class="img-dynamic have-shadow aspect-ratio img-round">
				...
				<?php if ( 'crop-image' == bp_get_avatar_admin_step() ) : ?>
					...
					<input class="btn btn-tertiary" type="submit" name="avatar-crop-submit" id="avatar-crop-submit" value="<?php esc_attr_e( 'Crop Image', 'buddypress' ); ?>" />
			...
			<?php if ( 'crop-image' != bp_get_avatar_admin_step() ) : ?>
				...
				<div class="submit d-flex" id="previous-next">
					...
					<?php if ( !bp_is_last_group_creation_step() && !bp_is_first_group_creation_step() ) : ?>
						...
						<input type="submit" value="<?php esc_attr_e( 'Next Step', 'buddypress' ); ?>" id="group-creation-next" class="btn-primary ml-auto" name="save" />
					...
					<?php if ( bp_is_first_group_creation_step() ) : ?>
						...
						<input type="submit" value="<?php esc_attr_e( 'Create Group and Continue', 'buddypress' ); ?>" class="btn-primary" id="group-creation-create" name="save" />
					...
					<?php if ( bp_is_last_group_creation_step() ) : ?>
						...
						<input type="submit" value="<?php esc_attr_e( 'Finish', 'buddypress' ); ?>" class="btn-primary ml-auto" id="group-creation-finish" name="save" />
