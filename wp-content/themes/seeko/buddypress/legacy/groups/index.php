		...
		<div class="item-list-tabs-wrapper">
			...
			<ul>
				...
				<?php if ( is_user_logged_in() && bp_get_total_group_count_for_user( bp_loggedin_user_id() ) ) : ?>
					<li id="groups-personal"><a href="<?php echo esc_url( bp_loggedin_user_domain() . bp_get_groups_slug() . '/my-groups/' ); ?>"><?php printf( __( 'My Groups %s', 'buddypress' ), '<span>' . bp_get_total_group_count_for_user( bp_loggedin_user_id() ) . '</span>' ); ?></a></li>
				<?php endif; ?>
