...
<fieldset class="group-create-privacy">
	...
	<div class="radio">
		...
		<div class="form-check">
			...
			<label for="group-status-public"><?php _e( 'This is a public group', 'buddypress' ); ?></label>
		</div>
...
<div class="form-group">
	<input type="submit" value="<?php esc_attr_e( 'Save Changes', 'buddypress' ); ?>" class="btn btn-primary" id="save" name="save" />
</div>
