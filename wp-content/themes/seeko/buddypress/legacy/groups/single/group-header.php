			...
			<div id="item-header-avatar">
				...
				<div class="user-avatar-wrapper">
					...
					<figure id="user-avatar" class="img-dynamic have-shadow aspect-ratio avatar">
						<a class="img-card" href="<?php echo esc_url( bp_get_group_permalink() ); ?>">
							<?php svq_bp_group_avatar( true ); ?>
						</a>
					</figure>
				...
				<h1 id="user-name" class="h3"><?php the_title();?></h1>

				<?php do_action( 'bp_group_header_list_items' ); ?>
