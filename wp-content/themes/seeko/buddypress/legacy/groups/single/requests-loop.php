...
<?php if ( bp_group_has_membership_requests( bp_ajax_querystring( 'membership_requests' ) ) ) : ?>
	...
	<ul id="request-list" class="item-list list-unstyled row">
		<?php while ( bp_group_membership_requests() ) : bp_group_the_membership_request(); ?>

			<li class="item-list group-request-list <?php echo esc_attr( implode( ' ', $classes ) ); ?>">
				<div class="item-container">
					...
					<div class="item-card">
						...
						<div class="action text-center">
							...
							<?php bp_button( array( 'id' => 'group_membership_accept', 'component' => 'groups', 'wrapper_class' => 'btn btn-sm accept', 'link_href' => bp_get_group_request_accept_link(), 'link_text' => __( 'Accept', 'buddypress' ) ) ); ?>

							<?php bp_button( array( 'id' => 'group_membership_reject', 'component' => 'groups', 'wrapper_class' => 'btn btn-sm reject', 'link_href' => bp_get_group_request_reject_link(), 'link_text' => __( 'Reject', 'buddypress' ) ) ); ?>
