		...
		<div class="activity-meta">
			...
			<?php if ( is_user_logged_in() ) : ?>
				...
				<?php if ( bp_activity_can_comment() ) : ?>
					...
					<a href="<?php bp_activity_comment_link(); ?>" class="button acomment-reply bp-primary-action" id="acomment-comment-<?php bp_activity_id(); ?>"><?php printf( esc_html__( 'Comment %s', 'buddypress' ), '<span>' . bp_activity_get_comment_count() . '</span>' ); ?></a>
		...
		<div class="activity-comments">
			...
			<?php if ( is_user_logged_in() && bp_activity_can_comment() ) : ?>
				...
				<form action="<?php bp_activity_comment_form_action(); ?>" method="post" id="ac-form-<?php bp_activity_id(); ?>" class="ac-form"<?php bp_activity_comment_form_nojs_display(); ?>>
					...
					<div class="ac-reply-wrapper">
						<div class="ac-reply-avatar">
							<figure class="avatar avatar-square-sm">
								<div class="img-card">
						...
						<div class="ac-reply-content">
							...
							<input class="btn btn-sm btn-primary" type="submit" name="ac_form_submit" value="<?php esc_attr_e( 'Post', 'buddypress' ); ?>" />
