...
function buddypress_members_only_setting()
{
		...
		if (isset($_POST['bpmosubmitnew']))
		{
			...
			if (isset ( $_POST ['tomas_bbp_member_only_free_custom_links_login'] ))
			{
...
<?php //!!!start ?>
	...
	?>
										...
										<?php
											$tomas_bbp_member_only_free_custom_links_login = get_option('tomas_bbp_member_only_free_custom_links_login');
										?>
	<span><font color='gray'><?php echo get_option('siteurl').'/'; ?></font></span> <input type="text" id="tomas_bbp_member_only_free_custom_links_login" name="tomas_bbp_member_only_free_custom_links_login" size='10' value="<?php  echo $tomas_bbp_member_only_free_custom_links_login; ?>"> <font color='gray'>/</font>
										</p>
										<p>
													<font color="Gray"><i>
										<?php
...
?>
						<div id="dashboard-widgets-main-content">
							...
							<div class="inside">
									...
									<li>
										* Fine-grained access control for buddypress site, you can restrict each buddypress componets, control each menu visibility, control each user role's profile visibility, opt to restricts each wordpress pages(even home page), opt to restrict site RSS feed, opt to Opt to restricts specific BuddyPress Component Pages from search engines, opt to only allow approved members login your buddypress private network, you can decide which section of your site open / close to specific user roles. <b>more feature can be found at: <a class="" target="_blank" href="https://membersonly.top/features/">https://membersonly.top/features/</a></b>
									</li>
									<li>
